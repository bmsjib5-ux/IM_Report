...
export const SHEET_TYPE_CONFIG: Partial<Record<SheetType, SheetTypeConfig>> = {
  ...
  assessment: {
    ...
    columnOverrides: { 0: 'ลำดับที่' },
    statusField: 'สถานะการดำเนินการ',
    statusOptions: [
      'รอดำเนินการ',
      'กำลังดำเนินการ',
      'ดำเนินการแล้ว',
    ],
    requiredField: 'แบบประเมิน',
    mergeColumns: ['หน่วยงาน'],
    noPagination: true,
  },
  training: {
    headerRow: 1,
  ...
  report: {
    ...
    statusField: 'สถานะ',
    requiredField: ['ระบบงาน', 'ชื่อรายงาน'],
    mergeColumns: ['ระบบงาน'],
    noPagination: true,
  },
};
